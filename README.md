...
| Official Simulations | Pick a jurisdiction and the exam locks to its real published count, time and pass bar **only when the bank has enough unique questions**. Full pools run as locked official-format simulations; incomplete pools are explicitly labelled practice previews and cannot award an official-standard pass. Specs include CA 46/38, TX 30/21, NY 20/14, FL 50/40 in 60 min, WA 40/32, PA 18/15, UK 50/43 in 57 min (`js/exam-blueprints.js`, source-cited) |
...
Settings → "Your jurisdiction pack" selects a jurisdiction pack (CA, TX, NY, FL, WA, PA, or UK).
