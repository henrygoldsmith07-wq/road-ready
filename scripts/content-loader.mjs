...
function loadClassicScript(relPath, exportNames) {
...
export function loadContent(rootDir) {
  ...
  let p = {};
  try { p = loadClassicScriptFrom(root, "js/state-packs.js", ["STATE_PACKS"]); } catch { /* packs optional */ }
  return {
    ROOT: root,
    QUESTIONS: q.QUESTIONS,
    CATEGORIES: q.CATEGORIES,
    SIGNS: s.SIGNS,
    STATE_PACKS: p.STATE_PACKS || {},
  };
}
