/* Road Ready â€” state-specific content packs.
 *
 * Content model:
 *   Universal concepts  â€” js/questions.js (no jurisdiction tag): signs,
 *                         hazard recognition, positioning, following distance,
 *                         basic right-of-way. Rules common across states.
 *   Jurisdiction layer  â€” below. Each pack carries its own question set
...
const STATE_PACKS = {
  ...
  CA: {
    ...
    questions: [
      { id: "ca-001", cat: "alcohol", jurisdiction: ["CA"], concept: "zero-tolerance",
        ...
        choices: ["0.08% or more", "0.05% or more", "0.01% or more â€” any measurable amount", "There is no limit for minors"],
        a: 2,
        why: "California's zero-tolerance law (Vehicle Code Â§23136) suspends the license of any driver under 21 measuring 0.01% BAC or more â€” essentially one drink. Drivers 21+ are held to the 0.08% limit.",
      ...
      { id: "ca-002", cat: "alcohol", jurisdiction: ["CA"], concept: "bac-limits",
        ...
        a: 1,
        why: "Commercial drivers in California are limited to 0.04% BAC â€” half the standard 0.08% limit â€” because of the size and risk of the vehicles they operate.",
      ...
      { id: "ca-004", cat: "laws", jurisdiction: ["CA"], concept: "phone-use",
        ...
        choices: ["Only with a hands-free device", "Only at a red light", "Never â€” not even hands-free", "Only for navigation"],
        a: 2,
        why: "Under-18 provisional licensees in California may not use a phone at all while driving, even hands-free â€” the distraction, not just the handset, is the hazard. Drivers 18+ may use hands-free only.",
      ...
      { id: "ca-006", cat: "row", jurisdiction: ["CA"], concept: "right-on-red",
        ...
        a: 1,
        why: "Right on red is legal in California unless a sign prohibits it â€” but only after a COMPLETE stop and yielding to pedestrians and cross traffic. A rolling 'California stop' is still a violation.",
  ...
  TX: {
    ...
    questions: [
      { id: "tx-001", cat: "alcohol", jurisdiction: ["TX"], concept: "zero-tolerance",
        ...
        a: 1,
        why: "Texas forbids ANY detectable amount of alcohol for drivers under 21 â€” there is no minimum threshold like the adult 0.08% limit.",
      ...
      { id: "tx-002", cat: "speed", jurisdiction: ["TX"], concept: "speed-limits",
        ...
        a: 1,
        why: "Texas urban districts default to 30 mph unless signage posts otherwise. Rural highways carry higher defaults â€” always look for signs first.",
      ...
      { id: "tx-003", cat: "vulnerable", jurisdiction: ["TX"], concept: "school-bus",
        ...
        a: 1,
        why: "Texas requires stopping in both directions UNLESS a physical barrier (raised median or barrier) divides the road â€” paint alone does not exempt oncoming traffic.",
      ...
      { id: "tx-004", cat: "safety", jurisdiction: ["TX"], concept: "following-distance",
        ...
        a: 1,
        why: "Texas teaches a two-second minimum gap, stretched further at highway speeds or in poor weather â€” count 'one-thousand-one, one-thousand-two' between the car ahead passing a fixed point and you reaching it.",
      ...
      { id: "tx-006", cat: "laws", jurisdiction: ["TX"], concept: "phone-use",
        ...
        a: 0,
        why: "Texas bans reading, writing, or sending electronic messages while driving for ALL drivers statewide â€” many cities add stricter local ordinances.",
  ...
  NY: {
    ...
    facts: {
      ...
      handheldPhone: "Portable-electronics ban â€” fines plus points on your license",
    },
    questions: [
      { id: "ny-001", cat: "row", jurisdiction: ["NY"], concept: "right-on-red",
        ...
        choices: ["After a complete stop", "Never â€” right on red is prohibited citywide in NYC", "Only between 9am and 5pm", "Only onto one-way streets"],
        a: 1,
      ...
      { id: "ny-002", cat: "alcohol", jurisdiction: ["NY"], concept: "zero-tolerance",
        ...
        a: 2,
        why: "New York drivers under 21 face license suspension at just 0.02% BAC â€” well under the 0.08% adult DWI threshold.",
      ...
      { id: "ny-003", cat: "alcohol", jurisdiction: ["NY"], concept: "bac-limits",
        ...
        choices: ["Standard DWI charges only", "Aggravated DWI â€” harsher penalties", "No charge below 0.20%", "Only a warning for a first offense"],
        a: 1,
      ...
      { id: "ny-004", cat: "laws", jurisdiction: ["NY"], concept: "phone-use",
        ...
        a: 2,
        why: "New York's handheld-device ban adds POINTS to your license on top of fines â€” five points for a first conviction â€” because distraction crashes are a leading killer.",
      ...
      { id: "ny-006", cat: "safety", jurisdiction: ["NY"], concept: "following-distance",
        ...
        a: 2,
        why: "New York teaches roughly FOUR seconds of following space â€” longer than the classic two/three-second rules â€” to leave room for reaction plus braking in dense traffic.",
  ...
  FL: {
    ...
    questions: [
      { id: "fl-001", cat: "laws", jurisdiction: ["FL"], concept: "move-over",
        ...
        a: 1,
        why: "Florida's Move Over Act requires changing lanes away from stopped emergency/service/tow vehicles â€” or, when you can't change lanes, slowing to 20 mph BELOW the posted limit.",
      ...
      { id: "fl-002", cat: "alcohol", jurisdiction: ["FL"], concept: "zero-tolerance",
        ...
        a: 2,
        why: "Florida suspends the license of under-21 drivers measuring 0.02% BAC or more â€” roughly a single serving of alcohol.",
      ...
      { id: "fl-003", cat: "vulnerable", jurisdiction: ["FL"], concept: "school-bus",
        ...
        a: 1,
        why: "Florida exempts oncoming traffic ONLY when a PHYSICAL median divides the roadway. Pavement markings like a turn lane do NOT exempt you â€” both directions stop.",
      ...
      { id: "fl-004", cat: "safety", jurisdiction: ["FL"], concept: "following-distance",
        ...
        choices: ["One second", "Three seconds or more â€” extend to four+", "Shorter so drivers can't cut in", "Unchanged from dry conditions"],
        a: 1,
        why: "Florida teaches three seconds dry, extending beyond four in rain â€” wet pavement can double braking distance, and sudden downpours are routine.",
      ...
      { id: "fl-006", cat: "alcohol", jurisdiction: ["FL"], concept: "bac-limits",
        ...
        a: 1,
        why: "Florida presumes impairment at 0.08% BAC for drivers 21 and older, matching the nationwide standard â€” impairment can begin well below the legal line.",
        sourceId: "fl-flhsmv-handbook", sourceSection: "Driving Under the Influence" },
    ],
  },
  WA: {
    ...
    facts: {
      ...
      distractedDriving: "E-DUI law â€” even holding a phone at a light is an offense",
    },
    questions: [
      { id: "wa-001", cat: "laws", jurisdiction: ["WA"], concept: "distracted-driving",
        ...
        choices: ["Legal â€” you are not moving", "Legal for navigation only", "An offense â€” the law covers stops at lights too", "Only a secondary violation"],
        a: 2,
        why: "Washington's Driving Under the Influence of Electronics (E-DUI) act applies even when temporarily stopped at a light or sign â€” hold the phone, commit the offense.",
      ...
      { id: "wa-003", cat: "vulnerable", jurisdiction: ["WA"], concept: "school-bus",
        ...
        choices: ["Must stop in all cases", "May proceed with caution â€” four-lane divided roads are exempt", "Must stop for 30 seconds", "Must honk before proceeding"],
        a: 1,
      ...
      { id: "wa-004", cat: "safety", jurisdiction: ["WA"], concept: "following-distance",
        ...
        a: 1,
        why: "Washington extends the following interval to around four seconds in adverse weather â€” wet roads lengthen stopping distance dramatically.",
      ...
      { id: "wa-005", cat: "row", jurisdiction: ["WA"], concept: "right-on-red",
        ...
        a: 1,
        why: "Washington permits right on red following a full stop and yield â€” the same baseline rule used across most U.S. jurisdictions.",
  ...
  PA: {
    ...
    questions: [
      { id: "pa-001", cat: "laws", jurisdiction: ["PA"], concept: "work-zones",
        ...
        a: 1,
        why: "Pennsylvania doubles fines for work-zone violations and attaches mandatory penalties â€” safety corridors protect workers with little physical shielding.",
      ...
      { id: "pa-003", cat: "alcohol", jurisdiction: ["PA"], concept: "bac-limits",
        ...
        a: 1,
        why: "Pennsylvania tiers DUI: general impairment at 0.08%, HIGH rate at 0.10%, and HIGHEST rate at 0.16% â€” penalties grow sharply at each tier.",
      ...
      { id: "pa-005", cat: "safety", jurisdiction: ["PA"], concept: "following-distance",
        ...
        a: 1,
        why: "PennDOT's four-second guideline applies in poor conditions â€” rain, snow, ice, fog â€” when braking and reaction both degrade.",
